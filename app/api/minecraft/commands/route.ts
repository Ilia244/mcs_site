...
const DEFAULT_COMMANDS: MinecraftCommand[] = [
  ...
  { id: "vanish", category: "運営モード", command: "/vanish", name: "Vanish", description: "自分をVanish状態にします。", permission: "", target: "MCS Plugin", notes: "", sort_order: 40, enabled: true, required_role: "moderator" },
  { id: "lp-user", category: "権限管理", command: "/lp user <player> parent set <group>", name: "LuckPermsグループ変更", description: "指定プレイヤーのLuckPermsグループを変更します。", permission: "luckperms.user.parent.set", target: "LuckPerms", notes: "対象プレイヤーと変更先グループを確認してから実行してください。", sort_order: 50, enabled: true, required_role: "admin" },
  { id: "co-inspect", category: "調査", command: "/co inspect", name: "CoreProtect調査", description: "ブロックの設置・破壊などの履歴を確認する調査モードを切り替えます。", permission: "coreprotect.inspect", target: "CoreProtect", notes: "", sort_order: 60, enabled: true, required_role: "staff" },
]
